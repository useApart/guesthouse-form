...
1. 달력에서 입실일과 퇴실일을 차례로 누릅니다. 날짜마다 집별로 막대가 있어
   어디가 비었는지 바로 보입니다.
2. 그 기간에 비어 있는 곳만 선택지로 나옵니다. 한 곳만 비었으면 자동으로 골라집니다.
3. 성명·동호수·연락처·인원을 넣고 "예약 신청"을 누릅니다.
4. 관리사무소가 입금을 확인하면 확정됩니다. 이 화면을 다시 열면 진행 상태가 보입니다.
